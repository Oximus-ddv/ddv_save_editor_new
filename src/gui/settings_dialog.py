...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QSpinBox, QCheckBox, QTabWidget, QWidget,
    QFrame, QGroupBox, QRadioButton, QComboBox, QTextEdit,
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent, initial_settings: Optional[Dict[str, Any]] = None):
        ...
        self.excel_path = self._initial.get("excel_path", "Disney Dream Light ID List - Mainted by Rubyelf.xlsx")
        ...
        self.data_source = str(self._initial.get("data_source", "excel")).lower()
        ...
        self.data_source_excel_radio = None
    ...
    def setup_file_paths_tab(self, tab_widget):
        ...
        # Excel file path
        layout.addWidget(QLabel("Excel Data File:"))
        excel_layout = QHBoxLayout()
        self.excel_path_edit = QLineEdit(self.excel_path)
    ...
    def setup_data_source_tab(self, tab_widget):
        ...
        self.data_source_excel_radio = QRadioButton("Excel file")
        self.data_source_dict_radio = QRadioButton("Dict folder (JSON)")
        self.data_source_excel_radio.setChecked(self.data_source == "excel")
        self.data_source_dict_radio.setChecked(self.data_source == "dict")
        source_layout.addWidget(self.data_source_excel_radio)
    ...
    def setup_image_settings_tab(self, tab_widget):
        ...
        cache_layout.addWidget(QLabel("Higher values use more memory but improve performance"))
    ...
    def setup_backup_settings_tab(self, tab_widget):
        ...
        self.auto_backup_check = QCheckBox("Create automatic backups when loading/saving")
    ...
    def setup_encryption_tab(self, tab_widget):
        ...
        help_label = QLabel("The application will try this key first before prompting you.")
        help_label.setStyleSheet("color: #9E9E9E;")
    ...
    def clean_old_backups(self):
        ...
        QMessageBox.information(self, "Clean Backups", "Old backups cleaned successfully!")
    
    def reset_defaults(self):
        """Reset all settings to defaults"""
        self.excel_path_edit.setText("Disney Dream Light ID List - Mainted by Rubyelf.xlsx")
        ...
        self.data_source_excel_radio.setChecked(True)
