...
class PetEditorDialog(QDialog):
    ...
    def load_data(self):
        ...
        if self.image_service:
            pil_image = self.image_service.get_item_image(
                item_id, ItemCategory.PETS, size=(128, 128)
            )
            if pil_image:
                ...
                if pil_image.mode == "RGB":
                    ...
                    qim = QImage(
                        data, im2.size[0], im2.size[1], QImage.Format.Format_ARGB32
                    )
